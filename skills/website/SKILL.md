...
| Dates: a Postgres `date` arriving as midnight UTC and shifting every row a day, the noon-UTC anchor, calendar days vs instants as separate types | [reference/calendar-days-vs-instants.md](reference/calendar-days-vs-instants.md) |
